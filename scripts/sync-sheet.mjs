...
// CONFIGURATION
// ============================================
const CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQK3YFlLE9cyNMrmVS_y9J4_ZJ3O8kac71ip7XhY_mFprwb-pOwd_ENTbbdM_QmXUaSUIEZB34QcrM6/pub?gid=684955292&single=true&output=csv';
